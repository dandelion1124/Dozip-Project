...
<script>
    function sendValue() {
        window.opener.document.getElementById("pf_area").value=document.getElementById( "childValue" ).value;
        window.opener.document.getElementById("pf_cost").value=document.getElementById( "childValue1" ).value;

...
<div class="my_req_list">
	...
	<div style="padding:0 0 10px 2.5%; width:87%; border-bottom:3px double gray;">
		<ul style="padding:0px;">
			...
			<li style="font-size: 0.8rem; margin-bottom: 5px; list-style:none;"><span class="red">*</span>&nbsp;진행상태는 <b style="font-size:15px; background-color: lightblue;">[ 수락/거절 -> 계약요청/거절 -> 작성완료 -> 계약완료 -> 공사완료 ]</b> 순으로 진행됩니다.</li>
		</ul>
	</div>
	<div style="width:88%;">
				...
				<tr class="my_req_cont" style="font-size:13px; border-bottom:1px solid lightgray;
					...
					<form method="post" action="">
						<td class="req_accept">
							...
							<c:if test="${er.est_check=='공사완료'}"><span style="color:black;"><b>공사완료</b></span></c:if>
						</td>
					</form>
				</tr>
			</c:forEach>

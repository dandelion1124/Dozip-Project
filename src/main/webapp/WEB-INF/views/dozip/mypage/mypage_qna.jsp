...
<style>
    /* 고객센터문의 */
    #my_counsel_list { width: 99%; margin: 20px auto; }
    ...
    #my_qna_write_btn { border: 0; font-size: 1.2rem; font-weight:bold; background-color: #347844; text-align: center; width: 30%; height: 45px; }
    #my_qna_write_btn a { color: white; }
    #my_qna_text { text-align: center; font-weight: bold; margin-bottom: 200px; }
    #my_qna_text  a { text-decoration: underline; color: #347844; }
    ...
    <div class="qna_wrap">
        ...
        <div class="my_qna_cont">
            ...
            <div class="page_area">
                ...
                <c:if test="${p.page>1}"><a href="/dozip/my_qna?page=${p.page-1}"><img src="/images/dozip/left-arrow.png"></a></c:if>
                ...
                <c:forEach var="page" begin="${p.startpage}" end="${p.endpage}" step="1">
                    ...
                    <c:if test="${page!=p.page}"><a href="/dozip/my_qna?page=${page}">${page}</a></c:if>
                </c:forEach>

                <c:if test="${p.page>=p.maxpage}"><img src="/images/dozip/right-arrow.png"></c:if>
                <c:if test="${p.page<p.maxpage}"><a href="/dozip/my_qna?page=${p.page+1}"><img src="/images/dozip/right-arrow.png"></a></c:if>
            </div>
        </div>
    </div>

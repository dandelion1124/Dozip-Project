		...
		<div class="part1">
			...
			<div class="big_review">
				...
				<div class="big_review_cont">
					...
					<div id="review_go_box"><a onclick="location.href='/dozip/review_detail?re_no=12'"  id="review_go">해당 리뷰보러 가기 >> </a></div>
				</div>
			</div>
		</div>
				...
				<div class="card_inner">
					<c:if test = "${!empty reviewList}">
						<c:forEach var="i" begin="0" end="${fn:length(reviewList)-1}" step="1">
							<div class="gallery">
							<a class="images" onclick = "location.href='review_detail?re_no=${reviewList[i].re_no}';" alt="image"><img src="/images/dozip/ex01.png"></a>

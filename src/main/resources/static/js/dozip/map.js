...
function getListItem(index, places) {
    ...
    itemStr = '<span class="markerbg marker_' + (index+1) + '"></span>' +
                '<div class="info">' +
                '   <button value =' +places.place_name+' style="font-size:1rem; font-weight:bold" onclick="clicktest(value)">' + places.place_name + '</button><br/>';
...
function clicktest(name){
    ...
    if(check){
        location="/dozip/apply?name="+name;
    }
}

...
select portfolioT_no_seq.nextval
from dual; -- 시퀀스 확인
create sequence portfolioT_no_seq start with 1 increment by 1 nocache;
--생성
...
select est_num_seq.nextval
from dual; --시퀀스 확인
create sequence est_num_seq start with 1 increment by 1 nocache;
--생성
...
select bid_num_seq.nextval
from dual; --시퀀스 확인
create sequence bid_num_seq start with 1 increment by 1 nocache;
--생성
...
select contractT_no_seq.nextval
from dual; --시퀀스 확인
create sequence contractT_no_seq start with 1 increment by 1 nocache;
--생성
...
from dual; --시퀀스 확인
create sequence payT_no_seq start with 1 increment by 1 nocache;
--생성
...
select qnaT_no_seq.nextval
from dual; --시퀀스 확인
create sequence qnaT_no_seq start with 1 increment by 1 nocache;
--생성
...
select re_no_seq.nextval
from dual; --시퀀스 확인
create sequence re_no_seq start with 1 increment by 1 nocache;
--생성
